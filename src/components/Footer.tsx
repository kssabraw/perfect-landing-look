      ...
      <div className="container mx-auto">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 mt-0.5 text-brand-orange" viewBox="0 0 20 20" fill="currentColor">
              ...
              <li className="flex items-center">
                ...
                <span>contact@apexlabs.com</span>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 pt-8">
          ...
          <p className="text-gray-600 text-xs text-center mt-4">
            ...
            Please consult with a healthcare provider to determine if TRT is right for you.
          </p>
        </div>
      </div>
    </footer>
